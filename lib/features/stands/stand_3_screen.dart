...
/// Экран стенда 3 — выбор режима тестирования (с нагрузкой / без нагрузки)
class Stand3Screen extends StatelessWidget {
  const Stand3Screen({super.key});
...
class _Stand3Body extends StatelessWidget {
  const _Stand3Body();
                  ...
                  children: [
                    Expanded(
                      child: _TestTypeCard(
                        ...
                        delay: 0,
                        onTap: () => Navigator.pushNamed(context, kRouteStand3Loaded),
                      ),
                    ),
                    ...
                    Expanded(
                      child: _TestTypeCard(
                        ...
                        delay: 120,
                        onTap: () => Navigator.pushNamed(context, kRouteStand3Unloaded),
                      ),
                    ),
                  ],
                ),
