...
/// Экран стенда 2 — выбор режима тестирования (с нагрузкой / без нагрузки)
class Stand2Screen extends StatelessWidget {
  const Stand2Screen({super.key});
...
class _Stand2Body extends StatelessWidget {
  const _Stand2Body();
