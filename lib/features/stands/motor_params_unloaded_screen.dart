...
class _MotorParamsUnloadedScreenState
    extends State<MotorParamsUnloadedScreen> {
  ...
  String _errorText(String? code, AppLocalizations loc, {double? max}) {
    return switch (code) {
      'exceeded' => loc
          ...
          .replaceAll('{max}', (max ?? widget.maxPowerKwt).toStringAsFixed(0)),
