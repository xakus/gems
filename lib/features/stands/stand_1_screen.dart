          ...
          Expanded(
            child: Row(
              children: [
                Expanded(
                  child: _TestTypeCard(
                    image: 'assets/engin_test_type_image/small_engin_power.png',
                    label: loc.tr('stand_test_loaded'),
                    delay: 0,
                    onTap: () => Navigator.pushNamed(context, kRouteStand1Loaded),
                  ),
                ),
                const SizedBox(width: kPaddingLarge),
                Expanded(
                  child: _TestTypeCard(
                    image: 'assets/engin_test_type_image/small_engin_free.png',
                    label: loc.tr('stand_test_unloaded'),
                    delay: 120,
                    onTap: () => Navigator.pushNamed(context, kRouteStand1Unloaded),
                  ),
                ),
              ],
            ),
